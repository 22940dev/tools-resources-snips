(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://notes.nikitavoloboev.xyz/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://notes.nikitavoloboev.xyz/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://notes.nikitavoloboev.xyz/assets/css/just-the-docs-' + theme + ".css"
      );
    };
