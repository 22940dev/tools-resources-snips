(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://epictools.dev/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://epictools.dev/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://epictools.dev/assets/css/just-the-docs-' + theme + ".css"
      );
    };
